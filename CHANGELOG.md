...
### Changed
- **Nix.js compatibility**: bumped `@deijose/nix-js` peer and dependency to `^2.5.3`.

## [1.3.2] - 2026-04-12

### Fixed
- **Docs API Migration**: Replaced remaining deprecated `use*` API usages (`useRouter`, form helpers) with `nix*` equivalents in docs source to keep builds compatible with `@deijose/nix-js@2.1+`.
